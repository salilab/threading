...
class IMPTHREADINGEXPORT StructureElementMover : public IMP::core::MonteCarloMover {
  ...
  int pct_flip_ = 10; // percentage of time to try a polarity flip move
  int pct_offset_ = 50; // percentage of time to try a polarity flip move
  int pct_length_ = 20; // percentage of time to try a polarity flip move
