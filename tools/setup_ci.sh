...
conda create --yes -q -n python${python_version} -c salilab -c conda-forge python=${python_version} pip imp-nightly gxx_linux-64 eigen cereal swig cmake protobuf matplotlib
